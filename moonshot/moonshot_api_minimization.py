...
'''
file_robot_status = client1.files.create(file=Path("../dobot_robot/dobot_mg400.pdf"), purpose="file-extract")
'''
...
'''
file_content = client1.files.content(file_id=file_robot_status.id).text
np.save("mg400_api", file_content)