...
def main():
    ...
    pos_start = [[291, 10, 10, 0], [272, 12, 10, 0], [255, 13.5, 10, 0], [237, 14, 10, 0], [290, -178, 10, 0],
...
if __name__ == "__main__":
    main()
comment = ("自主theme，robot 自然语言控制，prむけ"
           "正确率，音频识别，code和robot的动画的对比来确定成功运行"
           "demo,prとして先端性を示す。多言语系统，多种语言的识别。未来を示す。"
           "机器人，自然语言控制，音频识别，多种语言的识别，未来性，多言语系统，code和robot的动画的对比来确定成功运行。")
