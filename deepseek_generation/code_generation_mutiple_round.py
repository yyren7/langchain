...
content_mg400_pick_and_place_en = ('Pick-and-place task: Assume there are k pick coordinates.'
                                   '1.First, move to a position 20 cm directly above the starting pick coordinate, '
                                   'then move 20 cm downward.'
...
object_pos = ("pos_object = [[291, 10, 12, 0], [272, 12, 12, 0], [255, 13.5, 12, 0], [237, 14, 12, 0], "
              "[290, -178, 12, 0], [271, -177, 12, 0], [252, -177, 12, 0], [233, -177, 12, 0]]")
pos_new = "z=10,pos_end = [158, 234, 86, 21],DO=1"
pos_transfer = "ip=192.168.250.101 , pos_object = [291, 10, 12, 0],pos_end = [158, 234, 36, 21],DO=1"

# 初始系统消息配置
robot_prompt = content_mg400_en
task_prompt = content_mg400_pick_and_place_en
user_prompt = user_input
position_information = positions
code_check_prompt = content_mg400_code_check_en

system_messages = [
    {"role": "system", "content": "api：" + api_code},
