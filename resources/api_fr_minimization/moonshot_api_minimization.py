...
'''
file_robot_status = client1.files.create(file=Path("../document/fr/fr_robot_status.pdf"), purpose="file-extract")
'''
...
'''
file_content5 = client1.files.content(file_id=file_robot_status.id).text
np.save("5", file_content5)