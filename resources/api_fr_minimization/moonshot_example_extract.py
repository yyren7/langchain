...
'''
file_robot_status = client1.files.create(file=Path("C://Users/J100052060/Downloads/fairino-python-sdk-master/fairino-python-sdk-master/windows/examples/force_rot_insertion.py"), purpose="file-extract")
'''
