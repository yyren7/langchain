    ...
    def autoMode(self):
        ...
        if self.checkFlag(key="OPERATING"):
            ...
            # NOTE:JOB_NO_200 = ポイントデータ書込み
                ...
                #パラメータ
                ref_point_no = self.referenceWord(tag="REF_POINT_NO")
                range_point_no = self.referenceWord(tag="RANGE_POINT_NO")
            ...
            # NOTE:JOB_NO_201 = グローバルフラグON
                ...
                self.updateDebugPhase(key="DEBUG", val="SETTING")
                flag_no = self.referenceWord(tag="FLAG_NO")
            ...
            # NOTE:JOB_NO_203 = グローバル変数値書き換え
                ...
                ref_point_no = self.referenceWord(tag="REF_POINT_NO")
                range_point_no = self.referenceWord(tag="RANGE_POINT_NO")
                self.runJob203(ref_point_no, range_point_no)
